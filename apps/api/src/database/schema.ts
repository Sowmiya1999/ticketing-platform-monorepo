import {  serial, varchar, integer,text,date,jsonb,timestamp, pgTable, pgEnum, boolean } from "drizzle-orm/pg-core";
import { InferSelectModel, relations } from "drizzle-orm";
import { Status } from "../lib/common/enum";

export const STATUS_ENUM = pgEnum("status_enum",["ACTIVE","INACTIVE","DELETED"]);
...
export const events = pgTable("events",{
    ...
    isDefaultPricingRulesEnabled: boolean("is_default_pricing_rules_enabled").default(true),
